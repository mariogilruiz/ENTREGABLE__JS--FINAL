...
const filerRpg = videogames.filter((element) => element.genders.includes('RPG') )

const notasSuma = videogames.reduce((acumulador , value) => {
    
    return acumulador + value.score
}, 0)

const notaMedia = notasSuma / videogames.length




console.log(notaMedia)
console.log(filerRpg)
