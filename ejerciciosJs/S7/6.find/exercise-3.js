...
const findAlienname = aliens.find((element) => element.name === 'Cucushumushu');

const findAlienMutation = mutations.find((element) => element.name === 'Porompompero')

console.log(findAlienname)
console.log(findAlienMutation)

findAlienname.mutation = findAlienMutation.description;
